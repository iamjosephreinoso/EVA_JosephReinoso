...
a persistence unit "EVA_ReinosoJoseph_SRVPersistenceUnit" which uses the JakartaEE default database.
...
In case you don't want to use JSF, simply delete this file and "src/main/webapp/beans.xml" and "src/main/java/ec/edu/ups/EVA_ReinosoJoseph_SRV/Jsf23Activator.java"
==========================

Testing:
This sample is prepared for running unit tests with the Arquillian framework.

The configuration can be found in "EVA_ReinosoJoseph_SRV/pom.xml":
...
artifact ("EVA_ReinosoJoseph_SRV.war") is already built. You can build
